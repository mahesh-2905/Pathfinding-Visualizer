const Maze1 = (startRow,endRow,startCol,endCol,Orientation)=>{
    const animations = []
...
const RecurssiveDivisionMazeHelper =(startRow,endRow,startCol,endCol,Orientation,animations)=>{
    ...
    if(Orientation === "Horizontal"){
        ...
        if(currRow-(startRow+2) > endCol-startCol){
            ...
            // RecurssiveDivisionMazeHelper(startRow,currRow-2,startCol,endCol,Orientation,animations)
            RecurssiveDivisionMazeHelper(startRow,currRow-2,startCol,endCol,"Vertical",animations)
        ...
        if(currCol-(startCol+2) > endRow-startRow){
            RecurssiveDivisionMazeHelper(startRow,endRow,startCol,currCol-2,"Vertical",animations)

        }
        else{
            RecurssiveDivisionMazeHelper(startRow,endRow,startCol,currCol-2,Orientation,animations)
